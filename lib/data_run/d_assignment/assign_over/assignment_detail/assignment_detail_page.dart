...
//
// Widget _buildSubmissionsTable(BuildContext context, WidgetRef ref) {
//
// }
//
// Widget _buildSubmissionsTable(BuildContext context, WidgetRef ref) {
...
//     value: assignmentSubmissionsAsync,
//     valueBuilder: (List<DataFormSubmission> submissions) {
//       if (submissions.isEmpty) {
//         return Center(child: Text(S.of(context).noSubmissions));
//       }
//
//       // Group submissions by formVersion
//       final groupedSubmissions = <String, List<DataFormSubmission>>{};
//       final groupedFormTemplate = <String, FormVersion>{};
//       for (var submission in submissions) {
//         final formVersion = submission.formVersion as FormVersion;
//         groupedSubmissions
//             .putIfAbsent(formVersion.formTemplate, () => [])
//             .add(submission);
//         groupedFormTemplate.putIfAbsent(
//             formVersion.formTemplate, () => formVersion);
//       }
//
//       return Column(
//         children: groupedSubmissions.entries.map((entry) {
//           final formVersion = entry.key;
//           final formSubmissions = entry.value;
//           final formTemplate = groupedFormTemplate[formVersion]!;
//
//           final columnHeaders =
//               formTemplate.formFlatFields.entries.where((entry) {
...
//                         submission.formData, submission.formVersion);
...
//                       ],
//                       onSelectChanged: (_) {
//                         _goToDataEntryForm(context, assignment, submission);
//                       },
//                     );
//                   }).toList(),
//                 ),
